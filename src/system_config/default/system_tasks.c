...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for DISPLAY Tasks. */
    xTaskCreate((TaskFunction_t) _DISPLAY_Tasks,
                "DISPLAY Tasks",
                1024, NULL, 1, NULL);

    /* Create OS Thread for RS232 Tasks. */
    xTaskCreate((TaskFunction_t) _RS232_Tasks,
                "RS232 Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _DISPLAY_Tasks ( void )

  Summary:
    Maintains state machine of DISPLAY.
*/
...
/*******************************************************************************
  Function:
    void _RS232_Tasks ( void )

  Summary:
    Maintains state machine of RS232.
*/
